...
* **Lua 58/100 vs .ks 87/100 (+29):** Lua is smaller/faster to embed; `.ks` has Go-style `select` + `fusion` CLI + `--bin`/file-local registry + 158 builtins out of box.
...
Grand total (sum of all 18 totals) = `1309 / 1800`, average `72.7/100`.
